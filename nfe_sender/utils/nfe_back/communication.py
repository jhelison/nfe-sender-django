...
import os
import tempfile
from certificate import CertificateA1, CertificateAsFile
import requests
...
URL = "https://sefazvirtual.fazenda.gov.br/NFeStatusServico4/NFeStatusServico4.asmx?wsdl"
SERVICE = "nfeStatusServicoNF"

xml = '<consStatServ xmlns="http://www.portalfiscal.inf.br/nfe" versao="4.00"><tpAmb>2</tpAmb><cUF>21</cUF><xServ>STATUS</xServ></consStatServ>'

xml = etree.fromstring(xml)


client = SefazClient(cert)
print(etree.tostring(client.post(URL, SERVICE, xml)))

# with SefazClient.get_client(cert, 'https://sefazvirtual.fazenda.gov.br/NFeStatusServico4/NFeStatusServico4.asmx?wsdl') as client:
#     print(client)
